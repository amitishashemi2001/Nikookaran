...
class TaskManager(models.Manager):
    def related_tasks_to_charity(self, user: User) -> QuerySet:
        return self.filter(charity=user.charity) if user.is_charity else self.none()

    def related_tasks_to_benefactor(self, user: User) -> QuerySet:
